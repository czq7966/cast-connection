...
//         super()
//         this.config = new Modules.Webrtc.Config();
...
//     getConfig(): Modules.Webrtc.Config {
...
//             }).then((sdp) => {
//                 let codec = this.config.codec || Modules.Webrtc.ECodecs.default;
